...
using Carlos.Domain.Repositories.Interfaces;
using Carlos.Infrastructure.Data.Repositories;
        ...
        public static IServiceCollection AddRepositoryModule(this IServiceCollection services)
        {
            ...
            services.Scan(scan => scan
                .FromAssembliesOf(typeof(IUnitOfWork), typeof(UnitOfWork))
                    ...
                    .AddClasses(classes => classes.InNamespaces("Carlos.Infrastructure.Data.Repositories"))
                    ...
                    .AddClasses(classes => classes.Where(type => type.Namespace.Equals("Carlos.Infrastructure.Data.Repositories") &&
