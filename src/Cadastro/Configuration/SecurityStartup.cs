using System;
using Carlos.Infrastructure.Configuration;
using System.IdentityModel.Tokens.Jwt;
using System.Text;
using Carlos.Infrastructure.Data;
using Carlos.Domain;
using Carlos.Security;
using Carlos.Security.Jwt;
using Carlos.Domain.Services;
...
using AuthenticationService = Carlos.Domain.Services.AuthenticationService;
using IAuthenticationService = Carlos.Domain.Services.Interfaces.IAuthenticationService;
